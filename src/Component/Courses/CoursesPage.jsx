  ...
  return (
    <div className="w-4/5 p-6 mx-auto my-8 rounded-lg text-gray-800">
      ...
      <p className="text-lg text-gray-600 text-center mt-6 leading-relaxed max-w-2xl mx-auto">
        Delhi Skill and Entrepreneurship University (DSEU) provides a wide range
        of courses to help students build industry-ready skills. Whether you're
        looking for an Undergraduate, Postgraduate, Diploma, or a specialized
        Certificate program, we've got you covered. Browse through our
        categories below!
      </p>
